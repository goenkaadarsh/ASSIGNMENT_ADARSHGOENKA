...
import com.springrest.SpringRestApp.service.EmployeeService;
...
public class EmployeeController {
	...
	public String create(@RequestParam String employeeName, @RequestParam String employeeDepartment,
			@RequestParam String employeeDesignation, @RequestParam int employeeSalary) {
	...
	public List<Employee> getbySalary(@RequestParam int employeeSalary) {
