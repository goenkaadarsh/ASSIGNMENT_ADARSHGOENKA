...
public class DisplayTrader_Transaction {
	public static void main(String[] args) {
		Trader t1=new Trader("Adarsh", "Kolkata");
		Trader t2=new Trader("Aditya", "Pune");
		Trader t3=new Trader("Sai Kiran", "Lucknow");
		Trader t4=new Trader("Atharva", "Pune");
		Trader t5=new Trader("Bhuvan", "Delhi");
		Trader t6=new Trader("Aayush", "Delhi");
